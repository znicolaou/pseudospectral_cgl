...
int main (int argc, char* argv[]) {
    ...
    if(argc != 16) {
        ...
        printf("A spiral is likely to nucleate out of amplitude turbulence with these parameters. Use the Mathematica notebook plot.nb to refine the grid and run the next example. If no spiral nucleation occurs or multiple spirals nucleate, try again.\n");
        printf("-----------------------------------------------------------------------\n");
