...
int main (int argc, char* argv[]) {
    ...
    if(argc != 16) {
        ...
        printf("-----------------------------------------------------------------------\n");
        printf("Example 1) ./2dcgleic 768 192 2.0 2.0 0.75 0.75 5e2 5e2 5e2 1 1e-3 1e-3 6 rkf45 random \n");
        ...
        printf("-----------------------------------------------------------------------\n");
        printf("Example 2) ./2dcgleic 1536 192 2.0 2.0 0.75 0.85 5e2 5e2 5e2 1 1e-3 1e-3 6 rkf45 refine \n");
